...
//	private float total;
	...
	public Panier() {
		...
		lignes.add(new LigneCommande(new Produit(1, "Acer Aspire 5 Slim Laptop" , 359, 1, "https://images-na.ssl-images-amazon.com/images/I/71vvXGmdKWL._AC_SL1500_.jpg",true,new Categorie(1,"categorie1","description1")), 1));
