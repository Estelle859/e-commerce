...
<body>
	...
	<section>
		<table>
			<td><a href="panier?id=${article.id}&action=addArticle">
			 <i	class="fa fa-plus-square"></i>
				...
				<c:forEach items="${ lignes }" var="element">
					<tr>
						...
						<td><a href="lignes?id=${element.id}&action=removeArticle"> <i
								class="fa fa-minus-square"></i></td>
						<td><a href="lignes?id=${element.id}&action=modifyArticle"> <i
